    ...
    <footer className="bg-[#121212] pt-16 mt-auto overflow-hidden relative">
      <div className="container mx-auto px-6 md:px-8 max-w-[1100px]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-16 gap-12 md:gap-0">
          ...
          <div className="max-w-md">
            ...
            <p className="text-gray-400 text-[15px] md:text-base leading-relaxed mb-8 pr-4">
              We're eager to hear from you! Whether you have questions about DJINN, want to explore custom AI solutions, or just want to connect, please - <Link href="/contact" className="underline text-gray-300 hover:text-white transition-colors">Get In Touch.</Link>
            </p>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"></line></svg>
              </a>
              {/* Facebook */}
              <a 
                href="#facebook"
              ...
              >
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 24 24"><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" /></svg>
              </a>
            </div>
          </div>
          ...
          <div className="flex flex-col items-start md:items-end gap-[13px] text-[15px]">
            {['Home', 'Features', 'Customized Applications', 'Resources', 'About Us', 'Privacy Policy', 'Terms & Conditions'].map((item, index) => (
              <Link 
                key={index} 
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-[13px] md:text-sm text-gray-400 gap-4 md:gap-0 lg:px-4 relative z-10">
          <p>Product of <span className="text-gray-200 font-medium">CloudMojo!</span></p>
          <p>This website uses <span className="text-gray-200 font-medium">cookies.</span></p>
          <p>All Rights Reserved © <span className="text-gray-200 font-medium">2025</span></p>
        </div>
      </div>

      {/* Bottom Huge DJINN TEXT */}
      <div className="w-full flex justify-center items-end mt-4 mb-[-5%] overflow-hidden relative z-0" style={{ height: "clamp(100px, 18vw, 300px)" }}>
        <h1 
